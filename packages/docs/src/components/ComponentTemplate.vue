<template>
  <article class="prose prose-a:text-yellow-300 prose-a:underline prose-a:font-bold prose-h1:text-white prose-h2:text-sky-300 prose-h2:py-4 prose-h2:px-6 prose-h2:m-0 prose-p:text-white max-w-none -mt-6 sm:mt-0 py-0 flex flex-col flex-1 overflow-auto">
    <div class="max-w-[960px] mx-auto pt-8 pb-0 sm:pt-16 w-full">
      <h1 class="text-shadow tracking-wider" v-text="title" />
    </div>
    
    <div class="flex-1 px-4 pb-8 max-w-[960px] mx-auto">
      <div v-if="demoComponent" class="section-container">
...
.section-container {
  @apply bg-slate-800 rounded-xl shadow-lg overflow-hidden mb-4 sm:mb-8 last:mb-0 relative;
}
