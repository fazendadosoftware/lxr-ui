<template>
  <article class="prose prose-a:text-yellow-300 prose-a:underline prose-a:font-bold prose-h1:text-white prose-h2:text-sky-300 prose-h2:py-4 prose-h2:px-6 prose-h2:m-0 prose-p:text-white max-w-none -mt-6 sm:mt-0 py-0 flex flex-col flex-1 overflow-hidden">
    ...
    <div class="overflow-auto pb-8">
      <div class="flex-1 px-4 max-w-[960px] mx-auto">
